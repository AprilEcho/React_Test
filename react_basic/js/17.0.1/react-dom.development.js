...
(function (global, factory) {
  ...
  // Filter certain DOM attributes (e.g. 06_src_github搜索案例_pubsub, href) if their values are empty strings.
  ...
  // Please consider also adding to 'react-devtools-shared/06_src_github搜索案例_pubsub/backend/ReactSymbols'
  ...
  function isCustomComponent(tagName, props) {
    ...
    switch (tagName) {
      ...
      case 'color-profile':
      case 'font-face':
      case 'font-face-06_src_github搜索案例_pubsub':
      case 'font-face-uri':
  ...
  function isSameOriginFrame(iframe) {
    try {
      ...
      // to throw, e.g. if it has a cross-origin 06_src_github搜索案例_pubsub attribute.
